...
import org.connecttag.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import org.connecttag.commons.models.AlarmSound
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://org.connecttag.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.app_commons), text)
