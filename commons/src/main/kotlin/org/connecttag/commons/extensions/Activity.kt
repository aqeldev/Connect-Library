...
import org.connecttag.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import org.connecttag.commons.databinding.DialogTitleBinding
import org.connecttag.commons.dialogs.*
import org.connecttag.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import org.connecttag.commons.helpers.*
import org.connecttag.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import org.connecttag.commons.helpers.MyContentProvider.MY_CONTENT_URI
import org.connecttag.commons.models.*
import org.connecttag.commons.views.MyTextView
import java.io.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=org.connecttag.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "org.connecttag.gallery" || applicationId == "org.connecttag.gallery.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "org.connecttag.phone.debug" else "org.connecttag.phone"
                val className = "org.connecttag.phone.activities.DialerActivity"
