package org.connecttag.commons.helpers
...
import org.connecttag.commons.extensions.getIntValue
import org.connecttag.commons.extensions.getStringValue
import org.connecttag.commons.models.PhoneNumber
import org.connecttag.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "org.connecttag.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "org.connecttag.phone" && packageName != "org.connecttag.messages" && packageName != "org.connecttag.calendar") {
                return contacts
            }
