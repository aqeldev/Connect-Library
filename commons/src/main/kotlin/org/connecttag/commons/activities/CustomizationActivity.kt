...
import org.connecttag.commons.databinding.ActivityCustomizationBinding
import org.connecttag.commons.dialogs.*
import org.connecttag.commons.extensions.*
import org.connecttag.commons.helpers.*
import org.connecttag.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import org.connecttag.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import org.connecttag.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import org.connecttag.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import org.connecttag.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import org.connecttag.commons.helpers.MyContentProvider.COL_THEME_TYPE
import org.connecttag.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import org.connecttag.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import org.connecttag.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import org.connecttag.commons.models.GlobalConfig
import org.connecttag.commons.models.MyTheme
import org.connecttag.commons.models.RadioItem
import org.connecttag.commons.models.isGlobalThemingEnabled
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("org.connecttag.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
    ...
    private fun updateHeaderColors(primaryColor: Int = getProperPrimaryColor()) {
        arrayListOf(binding.settingsThemeAndColorsLabel, binding.settingsAllAppsLabel).forEach {
    ...
    private fun showOrHideThankYouFeatures() {
        ...
        binding.settingsAllAppsLabel.beVisibleIf(showThankYouFeatures)
