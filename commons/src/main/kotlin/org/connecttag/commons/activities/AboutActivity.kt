...
class AboutActivity : BaseComposeActivity() {
    ...
    private fun getGithubUrl(): String {
        return "https://github.com/AqelDev/${intent.getStringExtra(APP_REPOSITORY_NAME)}"
    }
    ...
    private fun onGithubClick() {
        launchViewIntent("https://github.com/AqelDev")
    }

    private fun onRedditClick() {
        launchViewIntent("https://www.reddit.com/r/AqelDev")
    }


    private fun onTelegramClick() {
        launchViewIntent("https://t.me/AqelDev")
    }
